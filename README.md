...
- Contributions from [K.W.O.](https://staff.ucar.edu/users/oleson) and C.H. are based upon work supported by the NSF National Center for Atmospheric Research, which is a major facility sponsored by the U.S. National Science Foundation under Cooperative Agreement No. 1852977.
