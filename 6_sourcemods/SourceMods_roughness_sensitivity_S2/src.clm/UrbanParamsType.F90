...
!YS             lun%z_d_town(l) = (1._r8 + alpha**(-plan_ai) * (plan_ai - 1._r8)) * lun%ht_roof(l)
!YS
             lun%z_d_town(l) = 27.62_r8
!YS             
          end if
...
!YS 
             lun%z_0_town(l) = 2.53_r8            
!YS           
!YS              lun%z_0_town(l) = lun%ht_roof(l) * (1._r8 - lun%z_d_town(l) / lun%ht_roof(l)) * &
!YS                   exp(-1.0_r8 * (0.5_r8 * beta * C_d / vkc**2 * &
!YS                   (1 - lun%z_d_town(l) / lun%ht_roof(l)) * frontal_ai)**(-0.5_r8))
!YS 
!YS 
          end if
!KO
